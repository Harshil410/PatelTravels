			...
			<td style="width:145px;">
						...
						<div id="Lower" class="charttable" style="width:170px;">
									...
									<tr>
										...
										<img src="bus/bm.jpg" width="70" hspace="95">		<?php 
									for($lb=1;$lb<=5;$lb++)
									{
										if($lb!=3)
											{
								...
								<!--	<td class="seating" >
									...
									<input type="button" 
											...
											title="Seat-<?php echo $seatno; ?>&nbsp;&nbsp;&nbsp; SeatType-Seating" 
											class="seatconfirmed" 
											cursor="arrow">
									...
									<input type="button" 
											...
											onclick="book(s<?php echo $idseat; ?>)" 
											id="s<?php echo $idseat; ?>" 
											title="Seat-<?php echo $st; ?>&nbsp;&nbsp;&nbsp; SeatType-Seating" 
											class="seatconfirmed" 
											cursor="arrow">
									...
									<input type="button" 
											...
											onclick="book(s<?php echo $idseat; ?>)" 
											id="s<?php echo $idseat; ?>" 
											title="Seat-<?php echo $idseat; ?>&nbsp;&nbsp;&nbsp; SeatType-Seating"
											class="seatconfirmed" 
											cursor="arrow">
			...
			<td style="margin-top:-1px; padding-bottom:0px;" >
						 <table style="color:#5e5e5e;" cellpadding="5" cellspacing="0">
							...
							<tr>
									...
									<tr><td>
										<input type="text" name="txtCardNo"  maxlength="14" placeholder="Credit/Debit Card No"tabindex=5 class="indexCal" style="background-color:transparent" required>
									<tr><td>
										<input type="text" name="txtExpDt" placeholder="MM/YYYY" tabindex=6 class="indexCal" style="background-color:transparent" required>
									<tr><td>
										<input type="password" name="txtCardCod"  maxlength="03" placeholder="CVV" tabindex=7 class="indexCal" style="background-color:transparent" required>
									<tr><td><br></td></tr>
									</table>
									</td>		    		   		    
									</tr>
