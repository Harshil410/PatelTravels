...
<div style="background-color:white;margin-top:-55px;background-image:url('InShot_20180909_195556932.jpg');fixed;background-position:540% 50%;background-repeat:no-repeat;background-size: 1500px 1000px;">
	...
	<BR><BR> 
			...
			if(mysqli_affected_rows($con))
			{
				...
				while($data=mysqli_fetch_array($row))
				{
					...
					if($count == 1)
					{
						...
						{
		?>
							<table border=0 cellspacing=8 cellpadding=5 style="border:1px solid black;background-color:#f7f7f7">
							<tr>
								<td colspan=10 align=center style="font-family:verdana;font-size:18px;border:1px solid black;background-color:#dfe3ee"> -: Passenger Information :-</td>
							</tr>
							<tr>
							<td></td>
							</tr>
							<tr style="font-family:verdana;font-size:15px;color:blue">
							<td colspan=2><b>Passenger Name</b></b>
							<td><b>Contact No</ub></b>
							<td colspan=6><b>Email</b>
					<tr>
								<td colspan=2><?php if($nameCount == 0) echo $data[8]; ?></td>
								<td><?php if($nameCount == 0) echo $data[9]; ?></td>
								<td colspan=6><?php if($nameCount == 0) { echo $data[10]; $nameCount++; } ?></td>
		...
		<tr>
			...
			<td><a href="ticketCancel.php?seatNo=<?php echo $data[2]; ?>" style="text-decoration:none;color:red"><u>Cancel!</u></a></td>
		<?php		
					}
				} //While Loop End
		?>
