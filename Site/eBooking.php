...
<center>
	...
	<tr>
		...
		<td> <hr width=170>
		<td style="font-family:verdana;font-size:13px;background-color:silver;border-radius:20;color:white;">Find Bus
		<td><hr width=170>
...
<table cellspacing=20 class="tblBusSchedule" style="background-color:#dfe3ee">
 <td colspan=8 align=center style="border:4px solid black;background-color:	#f7f7f7">PLEASE SELECT BUS ROUTE</td>
