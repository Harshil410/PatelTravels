...
<script type="text/javascript">
		...
		j = prompt("What is your name?","abc");
	alert("WELCOME "+ j + " "+ "IN PATEL TRAVELS WEBSITE");
...
<body>
  ...
  <tr>
    <th><h2><center>POPULAR DESTINATIONS</center></h2></th>
...
<marquee direction="down" width="250" height="200" behavior="alternate" style="border:solid">
  <marquee behavior="alternate">
	Ahemdabad To Bhavnagar     
	<br>Ahemdabad To Rajkot
	<br>Jamnagar To Rajkot  
	<br>Jamnagar To Ahemdabad  
	</marquee>
</marquee>
