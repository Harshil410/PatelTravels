		...
		<td style="border-left:1px solid blue">
				<div style="padding-left:10px;opacity:0.8;color:white;font-family:verdana;font-size:10px">
					...
					<table cellspacing=12.5>
						...
						<tr><td colspan=2><input type=text name=name placeholder="NAME" class="indexCal"></td></tr>
						
						<tr><td colspan=2><input type=text name=no placeholder="MOBILE NO." class="indexCal"></td></tr>
						
						<tr><td colspan=2><input type=text name=em placeholder="EMAIL" class="indexCal"></td></tr>
						
						<tr><td colspan=2><input type=text name=rmk placeholder="REMARK" class="indexCal"></td></tr>
						...
						<tr></tr><td><input type="submit" value="Make Payment" name="payment" class="btnCheckBus"></td>
			...
			<td style="margin-top:-1px; padding-bottom:0px;" >
						 <table style="color:#5e5e5e;" cellpadding="0" cellspacing="0">
							<tr>
									...
									<form method="post">
									<input type="text" name="noSeats" placeholder="No of Selected Seats" id="noSeats" value="" class="indexCal" readonly><br>
									<input type="text" name="seatAmt" placeholder="Amount" id="seatAmt" value="" class="indexCal" readonly><br>
									
									<select id="seatlist" style="padding:5px 120px 5px 5px" readonly>
									</select>
									<br>
